                    ...
                    return (
                        <article key={post._id}>
                            ...
                            <div className="article_content">
                                ...
                                <button className={post.likes.filter(check_like).length > 0 ? "like" : "dislike"} onClick={() => like(post._id)}>
                                    ...
                                    {post.likes.length > 0
                                        ? post.likes.length > 5
                                            ? <span>Liked by <Link to={`/profile/${post.likes[0].username}`}><span className="bold_text">{post.likes[0].username}</span></Link> <span>and</span> {post.likes.length > 1
                                                ...
                                                : <span></span>}</span> : <span className="bold_text">{post.likes.length} likes</span>
                                        : <span></span>}
